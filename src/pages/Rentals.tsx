...
const features = [
  {
    ...
    description: "Find available motorcycles for rent near you.",
    link: "/browse-rentals"
  },
  {
    icon: MapPin,
    title: "Locations",
    description: "Search rental locations and dealers.",
    link: "/rental-locations"
  },
  {
    icon: Calendar,
    title: "Availability",
    description: "Check motorcycle availability and book online.",
    link: "/availability"
  },
  {
    icon: DollarSign,
    title: "Price Compare",
    description: "Compare rental prices and find the best deals.",
    link: "/rental-prices"
  },
  {
    icon: Shield,
    title: "Insurance",
    description: "Learn about rental insurance and coverage options.",
    link: "/rental-insurance"
  }
];
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Find and compare motorcycle rentals in your area. Browse available bikes, check prices, and book your next adventure.
              </p>
            </div>
          </div>
        </section>
