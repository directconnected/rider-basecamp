...
// Restaurant types
export type RestaurantType = 'any' | 'italian' | 'mexican' | 'chinese' | 'american' | 'thai' | 'japanese' | 'indian' | 'fast_food' | 'pizza' | 'seafood' | 'steakhouse' | 'vegetarian' | 'breakfast' | 'cafe' | 'barbecue';

// Attraction types
export type AttractionType = 'any' | 'museum' | 'park' | 'tourist_attractions' | 'amusement_park' | 'art_gallery' | 'historic_site' | 'natural_feature' | 'point_of_interest';
